...
import static com.stonedt.intelligence.util.StopWordsUtil.isLockWordsMonster;
                ...
                if (count < 10 && null != string && !"".equals(string.trim())) {
                    ...
                    for (int j = 0; j < jsonArray3.size(); j++) {
                        ...
                        if (null != integer && null == platform_name) {
                            switch (integer) {
                                case 1:
                                    jsonObject2.put("platform_name", "汽车之家");
                                    break;
                                case 2:
                                    jsonObject2.put("platform_name", "人民号");
                                    break;
                                case 3:
                                    jsonObject2.put("platform_name", "携程");
                                    break;
                                case 4:
                                    jsonObject2.put("platform_name", "东方头条");
                                    break;
                                case 5:
                                    jsonObject2.put("platform_name", "百家号");
                                    break;
                                case 6:
                                    jsonObject2.put("platform_name", "大风号");
                                    break;
                                case 7:
                                    jsonObject2.put("platform_name", "同花顺号");
                                    break;
                                case 8:
                                    jsonObject2.put("platform_name", "云掌号");
                                    break;
                                case 9:
                                    jsonObject2.put("platform_name", "中金在线");
                                    break;
                                case 10:
                                    jsonObject2.put("platform_name", "快传号");
                                    break;
                                case 11:
                                    jsonObject2.put("platform_name", "企鹅号");
                                    break;
                                case 12:
                                    jsonObject2.put("platform_name", "雪球");
                                    break;
                                case 13:
                                    jsonObject2.put("platform_name", "网易号");
                                    break;
                                case 14:
                                    jsonObject2.put("platform_name", "今日头条");
                                    break;
                                case 15:
                                    jsonObject2.put("platform_name", "搜狐号");
                                    break;
                                case 16:
                                    jsonObject2.put("platform_name", "新浪看点");
                                    break;
                                case 17:
                                    jsonObject2.put("platform_name", "天天快报");
                                    break;
                                case 18:
                                    jsonObject2.put("platform_name", "财富号");
                                    break;
                                case 19:
                                    jsonObject2.put("platform_name", "大众点评");
                                    break;
                                case 20:
                                    jsonObject2.put("platform_name", "小红书");
                                    break;
                                case 21:
                                    jsonObject2.put("platform_name", "58本地版");
                                    break;
                                case 22:
                                    jsonObject2.put("platform_name", "大鱼号");
                                    break;
                                case 23:
                                    jsonObject2.put("platform_name", "腾讯新闻");
                                    break;
                                case 24:
                                    jsonObject2.put("platform_name", "西瓜视频");
                                    break;
                                case 25:
                                    jsonObject2.put("platform_name", "趣头条");
                                    break;
                                case 26:
                                    jsonObject2.put("platform_name", "看点快报");
                                    break;
                                case 27:
                                    jsonObject2.put("platform_name", "扬子扬眼");
                                    break;
                                case 28:
                                    jsonObject2.put("platform_name", "新华财经传媒");
                                    break;
                                case 29:
                                    jsonObject2.put("platform_name", "掌上南通");
                                    break;
                                case 30:
                                    jsonObject2.put("platform_name", "扬州发布");
                                    break;
                                case 31:
                                    jsonObject2.put("platform_name", "宽频中吴");
                                    break;
                                case 32:
                                    jsonObject2.put("platform_name", "交汇点新闻");
                                    break;
                                case 33:
                                    jsonObject2.put("platform_name", "常州手机台");
                                    break;
                                case 34:
                                    jsonObject2.put("platform_name", "Zaker");
                                    break;
                                case 35:
                                    jsonObject2.put("platform_name", "东财股吧");
                                    break;
