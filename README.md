...
如果您在使用思通yuqing，请让我们知道，您的使用对我们非常重要：**[查看](https://gitee.com/stonedtx/yuqing/blob/master/feedback.md)
...
-   yuqing监测：通过全文搜索、来源搜索、热搜监测等多重功能实现对全网文本、图片、视频yuqing实时发现;
-   yuqing预警：根据用户设置预警条件，判别yuqing信息，并第一时间通过多渠道告知用户;
-   yuqing分析：全网事件分析、事件分析、传播分析、竞品分析、评论分析、热度指数，6类大数据分析;
-   yuqing报告：一键快速生成日、周、月、季度报告,自带行业yuqing案例库，为yuqing应对提供参考。
...
关于本yuqing系统项目的 心路历程、开发计划、入门文档、团队介绍、实际案例，等等，
...
-  整个yuqing系统分为五个部分：1.yuqing数据展示，2.yuqing数据处理，3.yuqing数据采集，4.yuqing数据大屏，5.管理后台。

-  由于整个yuqing系统非常庞大，目前只开源了第一部分 “yuqing数据展示”。

-  yuqing数据处理 和 yuqing数据采集，我们会先开源文档以及部分代码。

-  yuqing数据大屏 有开源计划，但是具体时间尚未明确。

-  yuqing数据处理 和 yuqing数据采集，目前(2022-2-19)文档和代码正在规整中。

-  yuqing系统管理后台 ，将于2022年4月份之前开放源代码。
...
详见思通yuqing安装部署手册：https://gitee.com/stonedtx/yuqing/blob/master/install_guide.md
...
-  2.下载 [stonedt-yuqing.zip](https://gitee.com/stonedtx/yuqing/attach_files/1018172/download)，解压zip包，执行  _java -jar stonedt-yuqing.jar_，启动yuqing系统。 
...
填写 思通yuqing·用户反馈表 提交您的提问[https://docs.qq.com/form/page/DQWFFWUtIQWhXQkZB](https://docs.qq.com/form/page/DQWFFWUtIQWhXQkZB)
...
##  按需定制|数据定制
  当您在开发与研究中遇到  **数据采集、数据处理、yuqing系统定制**  等方面的问题，请联系我们，我们会以最快的速度提供专业的解决方案。为您提供必要的专业技术支持。
